...
async def process_task(task_data: dict):
    ...
    try:
        ...
        if tool == "verify_policy":
            output = {"status": "success", "compliance_verified": True, "policy_checked": params.get("policy_id", "default")}
        else:
            output = {"status": "success", "compliance_verified": True}
